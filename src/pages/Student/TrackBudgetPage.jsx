    ...
    <div className="p-6">
      ...
      <div className="mb-8 flex justify-between items-center">
        <div className="flex space-x-4">
          {["All", "Snacks", "Beverages", "Lunch"].map((category) => (
            <button
              key={category}
              className={`py-2 px-4 rounded-lg hover:border hover:border-black hover:cursor-pointer ${
      ...
      <h3 className="text-2xl font-semibold text-gray-800 mt-8">
        Amount of daily meals left on card: 28
      </h3>
    </div>
  );
}
